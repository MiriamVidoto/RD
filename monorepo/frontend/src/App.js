...
function App() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen min-w-screen flex flex-col justify-center items-center">
      <Header />
      <div className="bg-white p-8 rounded-lg shadow-md w-full md:w-3/4 lg:w-3/4 grid grid-cols-1 md:grid-cols-2 gap-8">
